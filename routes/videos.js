...
// Personalized feed: videos from the accounts this user follows.
// The build itself lives in utils/followFeed.js, shared with the badge feed.
router.get('/feed/:username', async (req, res) => {
    try {
        ...
        res.json(await buildFollowFeed(req, username, { allowFallback: true }));
